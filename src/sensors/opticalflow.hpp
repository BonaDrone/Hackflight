    ...
    class OpticalFlow : public PeripheralSensor {
        ...
        public:
            ...
            virtual bool getJacobianObservation(float * H, float * x) override
            {
                ...
                Serial.println("OF Correct");
              
                if (fabs(x[6]) < 0.95 && flag)
                {
                ...
                // 8 column
                H[7] =  (x[6]*((2*_fx*x[8]*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9])))/z - (_fx*(2*x[6]*x[5] + 2*x[7]*x[4] - 2*x[8]*x[3])*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z))/2 + (x[8]*((2*_fx*x[6]*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9])))/z + (_fx*(2*x[6]*x[3] + 2*x[8]*x[5] - 2*x[9]*x[4])*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z))/2 - (x[7]*((2*_fx*x[9]*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9])))/z - (_fx*(2*x[6]*x[4] - 2*x[7]*x[5] + 2*x[9]*x[3])*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z))/2 - (x[9]*((2*_fx*x[7]*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9])))/z - (_fx*(2*x[7]*x[3] + 2*x[8]*x[4] + 2*x[9]*x[5])*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z))/2;
                ...
                // 9 column
                H[8] =  (x[9]*((2*_fx*x[6]*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9])))/z + (_fx*(2*x[6]*x[3] + 2*x[8]*x[5] - 2*x[9]*x[4])*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z))/2 - (x[6]*((2*_fx*x[9]*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9])))/z - (_fx*(2*x[6]*x[4] - 2*x[7]*x[5] + 2*x[9]*x[3])*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z))/2 - (x[7]*((2*_fx*x[8]*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9])))/z - (_fx*(2*x[6]*x[5] + 2*x[7]*x[4] - 2*x[8]*x[3])*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z))/2 + (x[8]*((2*_fx*x[7]*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9])))/z - (_fx*(2*x[7]*x[3] + 2*x[8]*x[4] + 2*x[9]*x[5])*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z))/2;
            ...
            virtual bool getInnovation(float * z, float * x) override
            {
                ...
                // predicted values
                _predictedObservation[0] = - _fx*(x[14] - _rates[1]) - (_fx*(x[3]*(x[6]*x[6] + x[7]*x[7] - x[8]*x[8] - x[9]*x[9]) - x[4]*(2*x[6]*x[9] - 2*x[7]*x[8]) + x[5]*(2*x[6]*x[8] + 2*x[7]*x[9]))*(x[6]*x[6] - x[7]*x[7] - x[8]*x[8] + x[9]*x[9]))/z_est;
                ...
                Serial.print(_rates[0]);
                Serial.print(",");
                Serial.print(_rates[1]);
                Serial.print(",");
                Serial.println(_rates[2]);
